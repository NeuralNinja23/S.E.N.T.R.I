...
class IntentAnalyzer:
    ...
    def __init__(self):
        ...
        self.prototypes: Dict[str, List[str]] = {
            ...
            "LIFESTYLE_QUERY": [
                ...
                "who do i live with",
                "do i live alone",
                "whos at home with me",
                "am i staying alone",
                "my apartment roommates",
                "where am i staying",
                "who is my roommate",
                "do i live with family",
                "do i live with friends",
                "my residential status",
            ],
            "PROJECTS_QUERY": [
                "what projects am i building",
                "what projects am i working on",
                "tell me about sentri",
                "what is genxai studio",
                "my active software projects",
                "projects i am developing",
                "what coding projects do i have",
                "sentri development",
            ],
            "GOALS_QUERY": [
    ...
    def analyze(self, query: str) -> str:
        ...
        query_clean = re.sub(
            r"\b(high centri|high sentri|high centry|high sentry|hi centri|hi sentri|hi centry|hi sentry|hello sentri)\b",
            "hi",
            query_clean,
        )
