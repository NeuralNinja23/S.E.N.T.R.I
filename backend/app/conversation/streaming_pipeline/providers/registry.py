from app.conversation.streaming_pipeline.providers.asr import ASRProvider, FasterWhisperASRProvider
from app.conversation.streaming_pipeline.providers.reasoning import ReasoningProvider, OllamaReasoningProvider
from app.conversation.streaming_pipeline.providers.tts import TTSProvider, KokoroTTSProvider
...
class ProviderRegistry:
    ...
    @staticmethod
    def get_tts(provider_id: str, voice_name: str = "af_sarah", **kwargs) -> TTSProvider:
