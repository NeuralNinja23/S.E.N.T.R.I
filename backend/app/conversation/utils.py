...
class ResponseCleaner:
    ...
    def clean(text: str) -> str:
        ...
        cleaned = re.sub(r"\*(sighs|clears throat|nods|smiles|giggles|laughs|chuckles|coughs|shrugs|waves|points|winks|whispers|gasps|yawns|screams|cries|groans|moans|snickers|scoffs|sigh|clear throat|nod|smile|gasp|shrug|yawn)\*", "", cleaned, flags=re.IGNORECASE)
