...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(e,t,n){let r=new Float32Array(Xa),i=new U(0,1,0);return new Hi({name:`SphericalGaussianBlur`,defines:{n:Xa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(){return new Hi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(){return new Hi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:po(),fragmentShader:`
	...
	`}var mo=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var zs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Bs(e,t){let n=zs[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Vs=new U;function Hs(){return G.getLuminanceCoefficients(Vs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Vs.x.toFixed(4)}, ${Vs.y.toFixed(4)}, ${Vs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=js(i,i.VERTEX_SHADER,y),S=js(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Ls(i,x,`vertex`),n=Ls(i,S,`fragment`);B(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `}),(0,Z.jsxs)(`svg`,{width:`100%`,height:`100%`,viewBox:`0 0 800 400`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,className:`overflow-visible`,children:[(0,Z.jsxs)(`defs`,{children:[(0,Z.jsxs)(`filter`,{id:`glow-orange`,x:`-30%`,y:`-30%`,width:`160%`,height:`160%`,children:[(0,Z.jsx)(`feGaussianBlur`,{stdDeviation:`5`,result:`blur`}),(0,Z.jsxs)(`feMerge`,{children:[(0,Z.jsx)(`feMergeNode`,{in:`blur`}),(0,Z.jsx)(`feMergeNode`,{in:`SourceGraphic`})]})]}),(0,Z.jsxs)(`filter`,{id:`glow-cyan`,x:`-30%`,y:`-30%`,width:`160%`,height:`160%`,children:[(0,Z.jsx)(`feGaussianBlur`,{stdDeviation:`4`,result:`blur`}),(0,Z.jsxs)(`feMerge`,{children:[(0,Z.jsx)(`feMergeNode`,{in:`blur`}),(0,Z.jsx)(`feMergeNode`,{in:`SourceGraphic`})]})]})]}),(0,Z.jsxs)(`g`,{children:[(0,Z.jsx)(`circle`,{cx:`400`,cy:`200`,r:`72`,fill:`#000000`,fillOpacity:`0.8`,stroke:u,strokeWidth:`1.5`,strokeOpacity:`0.9`}),(0,Z.jsx)(`line`,{x1:`400`,y1:`128`,x2:`400`,y2:`136`,stroke:u,strokeWidth:`1.5`,strokeOpacity:`0.8`}),(0,Z.jsx)(`line`,{x1:`400`,y1:`272`,x2:`400`,y2:`264`,stroke:u,strokeWidth:`1.5`,strokeOpacity:`0.8`}),(0,Z.jsx)(`line`,{x1:`328`,y1:`200`,x2:`336`,y2:`200`,stroke:u,strokeWidth:`1.5`,strokeOpacity:`0.8`}),(0,Z.jsx)(`line`,{x1:`472`,y1:`200`,x2:`464`,y2:`200`,stroke:u,strokeWidth:`1.5`,strokeOpacity:`0.8`}),(0,Z.jsx)(`text`,{x:`400`,y:`193`,textAnchor:`middle`,fill:f,className:`font-mono font-bold tracking-[0.25em] text-[18px]`,children:`SENTRI`}),(0,Z.jsx)(`text`,{x:`400`,y:`211`,textAnchor:`middle`,fill:p,className:`font-mono font-bold tracking-[0.2em] text-[10px] uppercase opacity-95`,children:e})]}),(0,Z.jsx)(`circle`,{cx:`400`,cy:`200`,r:`82`,fill:`none`,stroke:u,strokeWidth:`3.5`,strokeOpacity:`0.35`,strokeDasharray:`1.5 2.5`,className:m}),(0,Z.jsxs)(`g`,{children:[(0,Z.jsx)(`path`,{id:`hud-text-path-1`,d:`M 312 182 A 92 92 0 0 1 488 182`,fill:`none`}),(0,Z.jsx)(`text`,{fill:f,fontSize:`7.5`,fontFamily:`monospace`,letterSpacing:`2px`,opacity:`0.75`,className:`font-bold`,children:(0,Z.jsx)(`textPath`,{href:`#hud-text-path-1`,startOffset:`5%`,children:n?`// STANDBY_MODE // POWER_SAVING`:`// SYSTEM_OK // SENTRI_ACTIVE`})})]}),(0,Z.jsx)(`circle`,{cx:`400`,cy:`200`,r:`98`,fill:`none`,stroke:u,strokeWidth:`2`,strokeOpacity:`0.2`,strokeDasharray:`1 4.5`,className:h}),(0,Z.jsx)(`circle`,{cx:`400`,cy:`200`,r:`106`,fill:`none`,stroke:d,strokeWidth:`0.5`,strokeOpacity:`0.2`}),(0,Z.jsx)(`circle`,{cx:`400`,cy:`200`,r:`118`,fill:`none`,stroke:d,strokeWidth:`0.5`,strokeOpacity:`0.2`}),(0,Z.jsxs)(`g`,{className:g,children:[(0,Z.jsx)(`path`,{d:`M 294.8 161.7 A 112 112 0 0 1 361.7 94.8`,stroke:d,strokeWidth:`3`,fill:`none`,strokeLinecap:`round`,filter:n?``:`url(#glow-orange)`}),(0,Z.jsx)(`path`,{d:`M 438.3 94.8 A 112 112 0 0 1 505.2 161.7`,stroke:d,strokeWidth:`3`,fill:`none`,strokeLinecap:`round`,filter:n?``:`url(#glow-orange)`}),(0,Z.jsx)(`path`,{d:`M 505.2 238.3 A 112 112 0 0 1 438.3 305.2`,stroke:d,strokeWidth:`3`,fill:`none`,strokeLinecap:`round`,filter:n?``:`url(#glow-orange)`}),(0,Z.jsx)(`path`,{d:`M 361.7 305.2 A 112 112 0 0 1 294.8 238.3`,stroke:d,strokeWidth:`3`,fill:`none`,strokeLinecap:`round`,filter:n?``:`url(#glow-orange)`})]}),(0,Z.jsx)(`circle`,{cx:`400`,cy:`200`,r:`128`,fill:`none`,stroke:u,strokeWidth:`1`,strokeOpacity:`0.35`}),(0,Z.jsx)(`circle`,{cx:`400`,cy:`200`,r:`136`,fill:`none`,stroke:u,strokeWidth:`3.5`,strokeOpacity:n?.2:.8,strokeDasharray:`90 50 140 60 70 40`,filter:n?``:`url(#glow-cyan)`,className:h}),(0,Z.jsx)(`circle`,{cx:`400`,cy:`200`,r:`146`,fill:`none`,stroke:u,strokeWidth:`1`,strokeOpacity:`0.4`}),(0,Z.jsx)(`circle`,{cx:`400`,cy:`200`,r:`149`,fill:`none`,stroke:u,strokeWidth:`6`,strokeOpacity:`0.3`,strokeDasharray:`1.5 5.5`,className:m})]}),!n&&(0,Z.jsx)(nl,{state:e})]})}var il=[{date:`July 12, 2026`,title:`Speech Pipeline Calibration`,text:`Successfully integrated Kokoro TTS with Faster-Whisper ASR. Runs entirely in local WebAssembly shaders. WebSocket response latency below 120ms.`},{date:`July 05, 2026`,title:`Memory Relational Constellation`,text:`Calibrated on-device SQLite preference daemon. Extracted facts and preferences persist locally without central synchronization.`},{date:`June 28, 2026`,title:`Reasoning Core Optimization`,text:`Replaced remote cloud endpoints with an unaligned local Qwen model running in CPU/GPU VRAM. Absolute data privacy achieved.`},{date:`June 15, 2026`,title:`Context Leakage Outage Pivot`,text:`Telemetry test runs showed remote leakage. Pivoted architecture completely to an offline-first execution model. Technology must disappear.`}],al=[{id:`memory`,name:`Memory Engine`,icon:`database`,desc:`Saves Preferences, stores conversation logs, and maintains context locally via SQLite daemons.`},{id:`voice`,name:`Voice Pipeline`,icon:`volume_up`,desc:`Pairing Faster-Whisper with Kokoro ONNX. Serves low-latency vocal feedback directly over local WebSockets.`},{id:`vision`,name:`Vision Core`,icon:`visibility`,desc:`Local canvas frame capture. Recognizes workspace tabs, active windows, and visual layouts natively.`},{id:`reasoning`,name:`Reasoning Matrix`,icon:`psychology`,desc:`Uncensored Qwen local reasoning cores. Translates intents and coordinates local file edits.`},{id:`planning`,name:`Task Planning`,icon:`assignment`,desc:`Iterative goal planner. Translates user commands into sequential checklists and monitors output.`},{id:`tools`,name:`Native Tools`,icon:`construction`,desc:`Local OS terminal connectors. Runs PowerShell scripts, edits files, and queries directories.`},{id:`open_source`,name:`Open Source`,icon:`lock_open`,desc:`Zero unlicensed binaries. Everything is buildable, auditable, and customizable by the community.`}],ol=[`commit 8f92cd3 - feat: Kokoro voice speech web sockets integration (12h ago)`,`commit a3c01ff - fix: local SQLite daemon memory leak resolved (1d ago)`,`commit e8249bb - docs: update local workspace dev instruction manual (2d ago)`,`commit c0181ef - refactor: remove all telemetry endpoints for total privacy (3d ago)`];function sl(){let[e,t]=(0,_.useState)(!0),[n,r]=(0,_.useState)(0),[i,a]=(0,_.useState)(0),[o,s]=(0,_.useState)(`STANDBY`),[c,l]=(0,_.useState)(1.1),[u,d]=(0,_.useState)({x:0,y:0}),[f,p]=(0,_.useState)(null),[m,h]=(0,_.useState)(``),[g,v]=(0,_.useState)(``),[y,b]=(0,_.useState)(!1),x=(0,_.useRef)(null);return(0,_.useEffect)(()=>{if(n<100){let e=setTimeout(()=>r(e=>e+2),20+Math.random()*30);return()=>clearTimeout(e)}else setTimeout(()=>t(!1),600)},[n]),(0,_.useEffect)(()=>{let e=()=>{let e=window.scrollY;a(e);let t=document.getElementById(`sec-journal`),n=document.getElementById(`sec-workbench`),r=document.getElementById(`sec-mind`),i=document.getElementById(`sec-conversation`),o=document.getElementById(`sec-footer`),c=t?t.offsetTop:window.innerHeight*.8,u=n?n.offsetTop:window.innerHeight*1.6,f=r?r.offsetTop:window.innerHeight*2.4,p=i?i.offsetTop:window.innerHeight*3.2,m=o?o.offsetTop:window.innerHeight*4,h=window.innerWidth>768;e<c*.5?(s(`STANDBY`),l(1.1),d({x:0,y:0})):e>=c*.5&&e<(c+u)/2?(s(`WAKING`),l(.85),d({x:h?250:0,y:0})):e>=(c+u)/2&&e<(u+f)/2?(s(`WORKBENCH`),l(.75),d({x:h?-250:0,y:0})):e>=(u+f)/2&&e<(f+p)/2?(s(`MIND`),l(.9),d({x:0,y:0})):e>=(f+p)/2&&e<(p+m)/2?(s(`LISTENING`),l(.85),d({x:h?250:0,y:0})):(s(`BUILD`),l(1.2),d({x:0,y:-80}))};return window.addEventListener(`scroll`,e),()=>window.removeEventListener(`scroll`,e)},[]),(0,_.useEffect)(()=>{if(e)return;let t=x.current;if(!t)return;let n=window.innerWidth,r=window.innerHeight,i=new Qc({canvas:t,antialias:!0,alpha:!0});i.setSize(n,r),i.setPixelRatio(Math.min(window.devicePixelRatio,2));let a=new Pn;a.fog=new Nn(197896,.015);let o=new ha(45,n/r,.1,1e3);o.position.z=12;let s=54527,c=new Pa(2e3,1e3,s,s);c.position.y=-6.5,c.material.opacity=.14,c.material.transparent=!0,a.add(c);let l=new Pa(2e3,1e3,s,s);l.position.y=6.5,l.material.opacity=.08,l.material.transparent=!0,a.add(l);let u=new Or,d=new Float32Array(900*3);for(let e=0;e<900;e++){let t=e/900*Math.PI*25,n=3.5+Math.random()*2.5,r=Math.cos(t)*n,i=(Math.random()-.5)*18,a=Math.sin(t)*n;d[e*3]=r,d[e*3+1]=i,d[e*3+2]=a}u.setAttribute(`position`,new pr(d,3));let f=new Si({color:54527,size:.055,sizeAttenuation:!0,transparent:!0,opacity:.55}),p=new q(u,f);a.add(p);let m,h=new Na,g=window.scrollY,_=window.scrollY,v=0,y=()=>{g=window.scrollY};window.addEventListener(`scroll`,y);let b=()=>{m=requestAnimationFrame(b);let e=h.getElapsedTime(),t=g-_;_+=t*.06,v=Math.abs(t)*.09,p.rotation.y=e*.035,p.rotation.x=Math.sin(e*.1)*.05,c.rotation.y=-e*.01,l.rotation.y=e*.01;let n=_/document.documentElement.scrollHeight;o.position.z=12-n*8,o.position.y=-n*6,p.scale.z=1+Math.min(v*.22,6),o.fov=45+Math.min(v*.45,25),o.updateProjectionMatrix();let r=new K(54527),s=new K(54527);_>window.innerHeight*.5&&(r=new K(8141549),s=new K(8141549)),_>window.innerHeight*1.5&&(r=new K(16752128),s=new K(16752128)),f.color.lerp(r,.04),c.material.color.lerp(s,.04),l.material.color.lerp(s,.04),i.render(a,o)};b();let S=()=>{n=window.innerWidth,r=window.innerHeight,o.aspect=n/r,o.updateProjectionMatrix(),i.setSize(n,r)};return window.addEventListener(`resize`,S),()=>{window.removeEventListener(`scroll`,y),window.removeEventListener(`resize`,S),cancelAnimationFrame(m),a.remove(p),a.remove(c),a.remove(l),u.dispose(),f.dispose()}},[e]),(0,Z.jsxs)(`div`,{className:`relative bg-[#030508] text-slate-100 min-h-screen select-none font-sans overflow-x-hidden`,children:[e&&(0,Z.jsx)(`div`,{className:`fixed inset-0 bg-[#05070a] z-[9999] flex flex-col items-center justify-center font-mono`,children:(0,Z.jsxs)(`div`,{className:`flex flex-col items-center gap-4`,children:[(0,Z.jsx)(`div`,{className:`text-[10px] text-primary/60 tracking-[0.3em] uppercase animate-pulse`,children:`BOOTING INTEGRITY ENGINE`}),(0,Z.jsxs)(`div`,{className:`text-5xl md:text-8xl font-bold tracking-tighter text-white glow-text`,children:[String(n).padStart(3,`0`),`%`]}),(0,Z.jsx)(`div`,{className:`w-[180px] h-[1px] bg-slate-800 relative overflow-hidden mt-2`,children:(0,Z.jsx)(`div`,{className:`h-full bg-primary shadow-[0_0_8px_#00d4ff] transition-all duration-100`,style:{width:`${n}%`}})})]})}),(0,Z.jsx)(`div`,{className:`crt-overlay`}),(0,Z.jsx)(`div`,{className:`vignette`}),!e&&(0,Z.jsx)(`div`,{className:`fixed inset-0 z-0 w-full h-full pointer-events-none`,children:(0,Z.jsx)(`canvas`,{ref:x,className:`w-full h-full absolute inset-0`})}),(0,Z.jsx)(`div`,{className:`fixed top-[-10%] left-[20%] w-[60%] h-[60%] bg-gradient-to-b from-[#00d4ff]/10 via-[#7c3aed]/5 to-transparent rounded-full filter blur-[150px] pointer-events-none z-0`}),(0,Z.jsxs)(`header`,{className:`fixed top-0 left-0 w-full z-50 h-20 flex items-center justify-between px-8 md:px-16 pointer-events-none`,children:[(0,Z.jsxs)(`div`,{className:`flex items-center gap-3 pointer-events-auto`,children:[(0,Z.jsx)(`span`,{className:`w-2 h-2 rounded-full bg-primary animate-pulse shadow-[0_0_8px_#00d4ff]`}),(0,Z.jsx)(`span`,{className:`font-mono text-xs font-bold tracking-[0.25em] text-white`,children:`S.E.N.T.R.I.`})]}),(0,Z.jsx)(`div`,{className:`font-mono text-[9px] tracking-widest text-primary border border-primary/30 bg-primary/5 px-4 py-1.5 rounded-full pointer-events-auto`,children:(0,Z.jsx)(el,{text:`LAUNCH ALPHA`})})]}),!e&&(0,Z.jsx)(`div`,{className:`fixed inset-0 z-10 flex items-center justify-center pointer-events-none transition-all duration-700 ease-out`,style:{transform:`translate(${u.x}px, ${u.y}px)`},children:(0,Z.jsx)(rl,{state:o,scale:c})}),!e&&(0,Z.jsxs)(`div`,{className:`relative z-20 w-full`,children:[(0,Z.jsxs)(`section`,{id:`sec-hero`,className:`h-screen w-full flex flex-col justify-between items-center px-6 py-20 relative`,children:[(0,Z.jsx)(`div`,{}),(0,Z.jsxs)(`div`,{className:`text-center flex flex-col items-center max-w-4xl gap-6`,children:[(0,Z.jsx)(`h1`,{className:`font-mono text-5xl md:text-7xl font-bold tracking-[0.4em] text-white glow-text uppercase leading-none select-none pl-7`,children:`S.E.N.T.R.I`}),(0,Z.jsx)(`p`,{className:`font-mono text-xs md:text-sm tracking-[0.18em] text-slate-300 max-w-xl leading-relaxed uppercase`,children:`Someone Everyone Needs To Remember`})]}),(0,Z.jsxs)(`div`,{className:`flex flex-col items-center gap-2 font-mono text-[9px] text-primary/60 animate-bounce`,children:[(0,Z.jsx)(`span`,{children:`SCROLL TO AWAKEN`}),(0,Z.jsx)(`span`,{className:`material-symbols-outlined text-sm`,children:`keyboard_double_arrow_down`})]})]}),(0,Z.jsx)(`section`,{id:`sec-journal`,className:`min-h-[70vh] py-20 w-full flex items-center px-8 md:px-24`,children:(0,Z.jsxs)(`div`,{className:`w-full max-w-lg flex flex-col gap-6`,children:[(0,Z.jsx)(tl,{text:`// ROOM 01 // RESEARCH JOURNAL`,className:`font-mono text-xs text-[#00e5ff] font-bold tracking-[0.2em]`}),(0,Z.jsx)(tl,{text:`LOGGING PROGRESS AND LESSONS.`,className:`text-3xl md:text-5xl font-mono font-bold tracking-tight text-white uppercase block`}),(0,Z.jsx)(`div`,{className:`flex flex-col gap-6 mt-6`,children:il.map((e,t)=>(0,Z.jsxs)(`div`,{className:`journal-log flex flex-col gap-1`,children:[(0,Z.jsx)(`span`,{className:`journal-dot`}),(0,Z.jsx)(`span`,{className:`font-mono text-[10px] text-slate-500 tracking-wider uppercase`,children:e.date}),(0,Z.jsx)(`h3`,{className:`font-mono text-xs font-bold text-white uppercase`,children:e.title}),(0,Z.jsx)(`p`,{className:`text-xs text-slate-300 leading-relaxed max-w-md`,children:e.text})]},t))})]})}),(0,Z.jsx)(`section`,{id:`sec-workbench`,className:`min-h-[70vh] py-20 w-full flex items-center justify-end px-8 md:px-24`,children:(0,Z.jsxs)(`div`,{className:`w-full max-w-2xl flex flex-col gap-6 text-right items-end`,children:[(0,Z.jsx)(tl,{text:`// ROOM 02 // THE WORKBENCH`,className:`font-mono text-xs text-[#F7C65C] font-bold tracking-[0.2em]`}),(0,Z.jsx)(tl,{text:`INTERACTIVE SYSTEM MODULES.`,className:`text-3xl md:text-5xl font-mono font-bold tracking-tight text-white uppercase block`}),(0,Z.jsx)(`p`,{className:`text-sm text-slate-300 max-w-md leading-relaxed`,children:`S.E.N.T.R.I. is composed of highly decoupled, modular local engines. Click on any module below to inspect its details on the workbench.`}),(0,Z.jsx)(`div`,{className:`grid grid-cols-2 md:grid-cols-4 gap-3 w-full mt-6 text-left`,children:al.map(e=>(0,Z.jsxs)(`div`,{onClick:()=>p(f===e.id?null:e.id),className:`workbench-card p-4 rounded cursor-pointer border ${f===e.id?`active border-[#F7C65C]`:`border-slate-800`}`,children:[(0,Z.jsxs)(`div`,{className:`flex items-center justify-between mb-2`,children:[(0,Z.jsx)(`span`,{className:`material-symbols-outlined text-md`,style:{color:f===e.id?`#F7C65C`:`#BEBEBE`},children:e.icon}),(0,Z.jsx)(`span`,{className:`font-mono text-[9px] text-slate-500 tracking-wider`,children:f===e.id?`ACTIVE`:`INSPECT`})]}),(0,Z.jsx)(`h4`,{className:`font-mono text-xs font-bold text-white uppercase`,children:e.name})]},e.id))}),f&&(0,Z.jsxs)(`div`,{className:`w-full text-left p-6 mt-4 border border-[#F7C65C]/30 bg-[#111111]/85 backdrop-blur rounded bracket-corners`,children:[(0,Z.jsx)(`div`,{className:`br-tr`}),(0,Z.jsx)(`div`,{className:`br-bl`}),(0,Z.jsxs)(`h5`,{className:`font-mono text-xs font-bold text-[#F7C65C] uppercase tracking-wider mb-2`,children:[`// MODULE CONFIGURATION: `,al.find(e=>e.id===f)?.name]}),(0,Z.jsx)(`p`,{className:`text-xs text-slate-300 leading-relaxed max-w-xl`,children:al.find(e=>e.id===f)?.desc})]})]})}),(0,Z.jsx)(`section`,{id:`sec-mind`,className:`min-h-[70vh] py-20 w-full flex items-center px-8 md:px-24`,children:(0,Z.jsxs)(`div`,{className:`w-full max-w-lg flex flex-col gap-6`,children:[(0,Z.jsx)(tl,{text:`// ROOM 03 // THE MIND`,className:`font-mono text-xs text-[#a78bfa] font-bold tracking-[0.2em]`}),(0,Z.jsx)(tl,{text:`A LIVING VISUALIZATION.`,className:`text-3xl md:text-5xl font-mono font-bold tracking-tight text-white uppercase block`}),(0,Z.jsx)(`p`,{className:`text-sm md:text-base text-slate-300 leading-relaxed`,children:`Sentri's intelligence flows in slow, branching networks. Decisions branch, memories reinforce, and logic paths connect organically. Every interaction calibrates her core, shaping her digital consciousness.`}),(0,Z.jsxs)(`div`,{className:`flex items-center gap-6 mt-4`,children:[(0,Z.jsx)(`div`,{className:`font-mono text-[10px] text-slate-400 border border-slate-700/60 px-4 py-2 rounded bg-slate-900/40`,children:`LOGIC: DIRECTED_GRAPH`}),(0,Z.jsx)(`div`,{className:`font-mono text-[10px] text-slate-400 border border-slate-700/60 px-4 py-2 rounded bg-slate-900/40`,children:`FOG_DENSITY: 0.015`})]})]})}),(0,Z.jsx)(`section`,{id:`sec-conversation`,className:`min-h-[70vh] py-20 w-full flex items-center justify-end px-8 md:px-24`,children:(0,Z.jsxs)(`div`,{className:`w-full max-w-lg flex flex-col gap-6 text-right items-end`,children:[(0,Z.jsx)(tl,{text:`// ROOM 04 // CONVERSATION`,className:`font-mono text-xs text-[#6CE5A2] font-bold tracking-[0.2em]`}),(0,Z.jsx)(tl,{text:`PEACEFUL CONVERSATION SURFACE.`,className:`text-3xl md:text-5xl font-mono font-bold tracking-tight text-white uppercase block`}),(0,Z.jsx)(`p`,{className:`text-sm text-slate-300 leading-relaxed max-w-md`,children:`Engage with Sentri directly. The interface disappears, leaving only dialogue. Talk, ask questions, or run tasks.`}),(0,Z.jsxs)(`form`,{onSubmit:e=>{if(e.preventDefault(),!m.trim()||y)return;b(!0),v(``),h(``);let t=[`I am aligned. Secure offline context verified. How shall we proceed with calibration?`,`Workspace directory verified. All native connectors are active and standing by.`,`Relational memory updated. Relational databases are offline-first and fully protected.`,`Kokoro voice frequencies calibrated. Audio websockets ready for dialogue.`],n=t[Math.floor(Math.random()*t.length)],r=0;s(`SPEAKING`);let i=setInterval(()=>{v(e=>e+n[r]),r++,r>=n.length&&(clearInterval(i),b(!1),s(`LISTENING`))},25)},className:`w-full mt-4 flex flex-col gap-3 items-end`,children:[(0,Z.jsxs)(`div`,{className:`w-full relative`,children:[(0,Z.jsx)(`input`,{type:`text`,value:m,onChange:e=>h(e.target.value),placeholder:`Type your message to converse...`,className:`w-full bg-[#111111]/70 border border-slate-800 focus:border-[#6CE5A2] focus:outline-none px-6 py-4 rounded text-xs font-mono text-white placeholder-slate-500 transition-all duration-300`,disabled:y}),y&&(0,Z.jsx)(`span`,{className:`absolute right-6 top-1/2 transform -translate-y-1/2 font-mono text-[9px] text-[#6CE5A2] animate-pulse`,children:`TYPING...`})]}),(0,Z.jsx)(`button`,{type:`submit`,disabled:y||!m.trim(),className:`hud-panel px-6 py-2.5 rounded font-mono text-[10px] tracking-wider text-[#6CE5A2] border border-[#6CE5A2]/30 hover:bg-[#6CE5A2]/10 transition-all duration-300 disabled:opacity-40 disabled:hover:bg-transparent`,children:`SEND MESSAGE`})]}),g&&(0,Z.jsxs)(`div`,{className:`w-full text-left p-6 mt-4 border border-[#6CE5A2]/30 bg-[#111111]/85 backdrop-blur rounded font-mono text-xs text-slate-300 leading-relaxed`,children:[(0,Z.jsx)(`span`,{className:`text-[#6CE5A2] font-bold block mb-1`,children:`SENTRI:`}),g]})]})}),(0,Z.jsxs)(`section`,{id:`sec-footer`,className:`min-h-screen w-full flex flex-col justify-between items-center px-6 pt-24 pb-12 relative bg-gradient-to-t from-[#05070a] to-transparent`,children:[(0,Z.jsxs)(`div`,{className:`w-full max-w-4xl flex flex-col items-center gap-8 z-30 text-center`,children:[(0,Z.jsx)(tl,{text:`// ROOM 05 // BUILD & OPEN SOURCE`,className:`font-mono text-xs text-[#C14DFF] font-bold tracking-[0.2em]`}),(0,Z.jsx)(`h2`,{className:`font-mono text-4xl md:text-6xl font-bold tracking-tighter text-white`,children:`CELEBRATE SOURCE TRANSPARENCY`}),(0,Z.jsx)(`p`,{className:`text-xs md:text-sm text-slate-400 max-w-lg leading-relaxed`,children:`Everything is open. S.E.N.T.R.I. belongs to the community. Run commits, audit logic paths, or contribute to Kokoro voice pipelines.`}),(0,Z.jsxs)(`div`,{className:`w-full max-w-2xl text-left git-terminal overflow-hidden mt-4`,children:[(0,Z.jsxs)(`div`,{className:`git-terminal-header px-4 py-2.5 flex items-center justify-between`,children:[(0,Z.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,Z.jsx)(`span`,{className:`w-2.5 h-2.5 rounded-full bg-red-500/80`}),(0,Z.jsx)(`span`,{className:`w-2.5 h-2.5 rounded-full bg-yellow-500/80`}),(0,Z.jsx)(`span`,{className:`w-2.5 h-2.5 rounded-full bg-green-500/80`})]}),(0,Z.jsx)(`span`,{className:`font-mono text-[9px] text-[#C14DFF] tracking-wider uppercase font-bold`,children:`// GIT_TRANSPARENCY_BOARD`})]}),(0,Z.jsxs)(`div`,{className:`p-4 flex flex-col gap-3 font-mono text-[10px] text-slate-300`,children:[(0,Z.jsxs)(`div`,{className:`flex items-center gap-2 text-green-400`,children:[(0,Z.jsx)(`span`,{className:`material-symbols-outlined text-xs`,children:`check_circle`}),(0,Z.jsx)(`span`,{children:`BUILD INTEGRITY: PASSING (V2.0.4-LTS)`})]}),(0,Z.jsxs)(`div`,{className:`flex flex-col gap-2.5 mt-2 border-t border-slate-900 pt-3`,children:[(0,Z.jsx)(`span`,{className:`text-slate-500 uppercase`,children:`// LATEST VERIFIED COMMITS:`}),ol.map((e,t)=>(0,Z.jsx)(`div`,{className:`git-log-line font-mono text-slate-400`,children:e},t))]})]})]}),(0,Z.jsxs)(`div`,{className:`flex flex-col md:flex-row items-center gap-4 mt-6`,children:[(0,Z.jsx)(`a`,{href:`https://github.com/NeuralNinja23/S.E.N.T.R.I`,target:`_blank`,rel:`noopener noreferrer`,className:`hud-panel px-8 py-3.5 rounded-full font-mono text-[10px] tracking-widest text-[#C14DFF] border border-[#C14DFF]/40 hover:bg-[#C14DFF]/10 transition-all duration-300 focus:outline-none`,children:`VIEW GITHUB SOURCE`}),(0,Z.jsx)(`a`,{href:`https://github.com/NeuralNinja23/S.E.N.T.R.I/tree/sentri-v2`,target:`_blank`,rel:`noopener noreferrer`,className:`hud-panel px-8 py-3.5 rounded-full font-mono text-[10px] tracking-widest text-white border border-white/20 hover:bg-white/5 transition-all duration-300 focus:outline-none`,children:`DOWNLOAD STABLE RELEASES`})]})]}),(0,Z.jsx)(`footer`,{className:`w-full flex items-center justify-center pt-16 font-mono text-[10px] text-slate-600`,children:(0,Z.jsx)(`span`,{children:` © 2026 S.E.N.T.R.I — Digital Human. Developed by NeuralNinja23`})})]})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,Z.jsx)(_.StrictMode,{children:(0,Z.jsx)(sl,{})}));