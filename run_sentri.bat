...
echo ===================================================
echo   S.E.N.T.R.I. Startup Manager
echo ===================================================
echo.
...
start "SENTRI_Backend" /min cmd /c "venv\Scripts\python -m uvicorn app.main:app --port 8008"

echo [System] Starting Frontend Server (Next.js on Port 3030)...
cd /d "%ROOT_DIR%frontend"
start "SENTRI_Frontend" /min cmd /c "npm run dev -- -p 3030"

echo [System] Waking up engines and loading CUDA caches...
timeout /t 5 /nobreak >nul

echo [System] Launching SENTRI Interface in Chrome (Port 3030)...
...
start /wait "" chrome --app=http://localhost:3030 --user-data-dir="%TEMP%\sentri_chrome_profile"

echo ===================================================
echo   Chrome window closed. Shutting down S.E.N.T.R.I.
echo ===================================================
echo.
